    ...
    <GameWrapper title="ШАШКИ" onBack={onBack}>
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="flex gap-8 items-center">
          ...
          <div 
            className="text-lg px-4 py-2 border-2 border-[#00ff00] rounded-lg"
            style={{ 
              ...
              row.map((piece, colIndex) => {
                ...
                return (
                  <button
                    ...
                    className="w-12 h-12 md:w-16 md:h-16 flex items-center justify-center text-3xl md:text-4xl border border-[#00ff00] transition-all relative"
                    style={{
                      ...
                      <div
                        ...
                        style={{
                          backgroundColor: piece.color === 'white' 
                            ...
                            : 'rgba(0, 0, 0, 0.9)',
                          border: `3px solid ${piece.color === 'white' ? '#ffffff' : '#00ff00'}`,
                          boxShadow: `0 0 10px ${piece.color === 'white' ? '#ffffff' : '#00ff00'}`,
                        }}
                      >
                        {piece.type === 'king' && (
                          <span className="text-xl" style={{ 
                            color: piece.color === 'white' ? '#000' : '#00ff00',
                            filter: `drop-shadow(0 0 3px ${piece.color === 'white' ? '#000' : '#00ff00'})`
                          }}>
                            ♔
                          </span>
                        )}
        ...
        <div className="flex flex-col gap-4 items-center">
          ...
          <button
            onClick={resetGame}
            className="px-6 py-3 bg-black border-3 border-[#00ff00] rounded-xl text-[#00ff00] hover:bg-[#00ff00] hover:text-black transition-all"
            style={{
              fontFamily: "'Press Start 2P', cursive",
              fontSize: '0.7rem',
              boxShadow: '0 0 15px rgba(0, 255, 0, 0.5)',
