    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <motion.button
          ...
          onClick={onBack}
          className="flex items-center gap-2 px-4 py-2 border-2 border-[#00ff00] rounded-lg text-[#00ff00] hover:bg-[#00ff00] hover:text-black transition-all duration-300"
          style={{
